...
The marketplace where data is scraped from are: [Cars.com](cars.com). Soon [Autotrader](autotrader.com) and [CarMax](carmax.com) will be added with more to come after.
